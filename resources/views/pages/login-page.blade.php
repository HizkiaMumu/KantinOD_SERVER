              ...
              <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <img src="logo/logo.png" alt="branding logo" style="width: 50%; height: auto;">
                  </div>
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal" action="/login" method="POST" novalidate>
                      ...
                      <button type="submit" class="btn btn-dark btn-block"><i class="ft-unlock"></i> Login</button>
                      <a href="/register" class="btn btn-outline-dark btn-block"><i class="ft-user"></i> Register</a>
                    </form>
                  </div>
                </div>
              </div>
