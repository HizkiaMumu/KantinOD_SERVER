...
data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
  <!-- ////////////////////////////////////////////////////////////////////////////-->
  <div style="background: rgba(0, 0, 0, 0.5); z-index: 1; top: 0; left: 0; right: 0; bottom: 0; position: fixed;"></div>
  <div class="app-content content" style="z-index: 1000;">
              ...
              <div class="card card-transparent box-shadow-0 border-0">
                <div class="card-content">
                  <div class="text-center">
                    ...
                    <img src="/logo/logo.png" class="img-responsive block width-300 mx-auto"
                    width="300" alt="bg-img">
                    <div id="clockFlat" class="card-text getting-started pt-1 mt-2 white d-inline-block"></div>
                    <div class="col-12 pt-1">
                      <p class="card-text lead white">Kami sedang mengerjakan sesuatu yang hebat.</p>
                    </div>
